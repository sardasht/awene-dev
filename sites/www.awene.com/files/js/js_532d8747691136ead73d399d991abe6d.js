...
;
Drupal.locale = { 'pluralFormula': function($n) { return Number(($n!=1)); }, 'strings': { "Unspecified error": "هەڵەیەکی نادیاریکراو", "Drag to re-order": "پەلکێشی بکە بۆ دووبارە ڕێکخستنەوە", "Alias: @alias": "نازناو: @alias", "No alias": "نازناو نییە", "Translate Text": "دەق وەرگێڕە" } };;
//v1.0
